...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileEvents = __webpack_require__(34);
	var entryEvents = __webpack_require__(38);
	var responseEvents = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onHideCat = function onHideCat() {
	  event.preventDefault();
	  $('#cats').hide();
	  $('.show-cat').show();
	  $('.hide-cat').hide();
	...
	var onShowCat = function onShowCat() {
	  event.preventDefault();
	  $('#cats').show();
	  $('.show-cat').hide();
	  $('.hide-cat').show();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var entryStorage = __webpack_require__(8);
	//const profileUi = require('../profile/profile-ui.js');
	...
	var profCheck = function profCheck(da) {
	  var length = da.profiles.length;
	  var user_id = $('.current').val();
	  if (length < user_id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var responseUi = __webpack_require__(9);
	var responseApi = __webpack_require__(30);
	var entryApi = __webpack_require__(31);
	var entryUi = __webpack_require__(32);

	var searchEntry = function searchEntry(data) {
	  var length = data.entries.length;
	  if (length !== 0) {
	    var lastEntry = data.entries[length - 1].date;
	...
	var resp = function resp(data) {
	  var sss = data.entry.responses[0];
	  if (sss !== undefined) {
	    getResponse().done(responseApi.showResponseQ);
	  } else {
	    $('.all-' + num).fadeIn(500).fadeOut(500);
	  }
	};

	var hasResp = function hasResp() {
	  return $.ajax({
	    url: app.host + '/entries/' + num,
	    method: 'GET',
	    headers: {
	...
	var deleteWarning = function deleteWarning(event) {
	  event.preventDefault();
	...
	var eventChain = function eventChain(event) {
	  event.preventDefault();
	...
	var onUnhide = function onUnhide(event) {
	  event.preventDefault();
	  $('.displayed-data').show();
	};

	var handlebarsBind = function handlebarsBind() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var scoreSort = function scoreSort() {
	...
	var responseFinal = function responseFinal() {
	  for (var i = 0; i < 20; i++) {
	    $('#' + (i + 1)).append(vals[i]);
	  }
	};

	var showResponseSet = function showResponseSet(questions) {
	  var responseTemplate = __webpack_require__(10);
	  $('.' + number).prepend(responseTemplate(questions));
	  responseFinal();
	  scoreSort();
	};

	var responseSetUp = function responseSetUp(data) {
	  var e = data.entry;
	  number = e.id;
	  for (var i = 0; i < e.responses.length; i++) {
	    var a = e.responses[i].question_id;
	    qOrder.push(a);
	    for (var _i = 0; _i < qOrder.length; _i++) {
	      var b = e.responses[_i].response_value;
	      var c = qOrder[_i];
	      vals[c - 1] = b;
	    }
	  }
	...
	module.exports = {
	  showResponseSet: showResponseSet,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"displayed-data cue-hide\">\n  <p id='total-score'>Total Score: </p>\n  <p id=\"severity\">Symptom Severity: </p> <br>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addResponse = function addResponse(data) {
	  return $.ajax({
	...
	var showResponseQ = function showResponseQ() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var esuccess = function esuccess(data) {
	...
	var showEntry = function showEntry(entries) {
	  var entryTemplate = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div id=\"mini\" class="
	    ...
	    + " <br>\n    Took meds: "
	    + alias4(((helper = (helper = helpers.meds_taken || (depth0 != null ? depth0.meds_taken : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"meds_taken","hash":{},"data":data}) : helper)))
	    + " <br>\n    <p class=\"all-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" style=\"display: none\">No survey responses documented!</p>\n    <p class=\"can-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" style=\"display: none\">Are you sure? Deletion is permanent!</p>\n    <input class=\"see-response h-button "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" type=\"submit\" name=\"submit\" value=\"See Entire Entry\"> <input class=\"delete-warn h-button "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" type=\"submit\" name=\"submit\" value=\"Delete Entry\"><br>\n    <input style=\"display: none\" class=\"delete-entry can-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " h-button "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" type=\"submit\" name=\"submit\" value=\"Delete\">\n    <input style=\"display: none\" class=\"cancel can-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " h-button "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	  ...
	  return "<div id=\"data-goes-here\" class=\"cue-hide mini\">\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(4);
	var profileApi = __webpack_require__(35);
	var profileUi = __webpack_require__(36);

	var onProfileCreate = function onProfileCreate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  profileApi.addProfile(data).done(profileUi.psuccess);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addProfile = function addProfile(data) {
	  return $.ajax({
	    url: app.host + '/profiles/',
	    method: 'POST',
	    headers: {
	...
	var seeProfile = function seeProfile() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var psuccess = function psuccess() {
	  $('#profile-options').hide();
	  $('.to-show').show();
	...
	var showProfileInfo = function showProfileInfo(profile) {
	  var profileTemplate = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onEntryCreate = function onEntryCreate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  entryApi.addEntry(data).done(entryUi.esuccess);
	};
	...
	var onShowEntries = function onShowEntries(event) {
	  ...
	  $('#vd').show();
	  $('.view-data').empty();
	  entryApi.listEntries().done(entryStorage.handlebarsBind);
	};

	var addEntryHandlers = function addEntryHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var responseStorage = __webpack_require__(40);

	var onResponseCreate = function onResponseCreate(event) {
	  event.preventDefault();
