...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileEvents = __webpack_require__(35);
	var entryEvents = __webpack_require__(39);
	var responseEvents = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCloseResponse = function onCloseResponse(event) {
	  event.preventDefault();
	  $("#present").modal('hide');
	  $(".displayed-data").html("");
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var responseApi = __webpack_require__(31);
	var entryApi = __webpack_require__(32);
	var entryUi = __webpack_require__(33);
	...
	var resp = function resp(data) {
	  var responseCheck = data.entry.responses.length;
	  if (responseCheck !== 0) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var responseStorage = __webpack_require__(10);
	//let number;
	//let vals = [];
	//let qOrder = [];
	//let sum = 0;
	...
	var showResponseSet = function showResponseSet(questions) {
	  var responseTemplate = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showEntry = function showEntry(entries) {
	  var entryTemplate = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(4);
	var profileApi = __webpack_require__(36);
	var profileUi = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showProfileInfo = function showProfileInfo(profile) {
	  var profileTemplate = __webpack_require__(38);
